...
class Braintrust::Test::PrimitiveModelTest < Minitest::Test
  A = Braintrust::Internal::Type::ArrayOf[-> { Integer }]
  H = Braintrust::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Braintrust::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Braintrust::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Braintrust::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Braintrust::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Braintrust::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Braintrust::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Braintrust::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Braintrust::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Braintrust::Internal::Type::Boolean, true] => true,
      [Braintrust::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Braintrust::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Braintrust::Internal::Type::Converter.new_coerce_state
      Braintrust::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Braintrust::Internal::Type::Converter.dump(target, input, state: state)
...
class Braintrust::Test::EnumModelTest < Minitest::Test
  class E0
    include Braintrust::Internal::Type::Enum
...
class Braintrust::Test::CollectionModelTest < Minitest::Test
  A1 = Braintrust::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Braintrust::Internal::Type::HashOf[Integer]

  A2 = Braintrust::Internal::Type::ArrayOf[H1]
  H2 = Braintrust::Internal::Type::HashOf[-> { A1 }]

  A3 = Braintrust::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Braintrust::Internal::Type::HashOf[Integer, nil?: true]
...
class Braintrust::Test::BaseModelTest < Minitest::Test
  class M1 < Braintrust::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Braintrust::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Braintrust::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Braintrust::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Braintrust::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Braintrust::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Braintrust::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Braintrust::Errors::ConversionError => e
...
class Braintrust::Test::UnionTest < Minitest::Test
  class U0
    include Braintrust::Internal::Type::Union
  ...
  class M2 < Braintrust::Internal::Type::BaseModel
  ...
  class M4 < Braintrust::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Braintrust::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Braintrust::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Braintrust::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Braintrust::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Braintrust::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Braintrust::Internal::Type::Unknown, Braintrust::Internal::Type::Unknown] => true,
      [Braintrust::Internal::Type::Boolean, Braintrust::Internal::Type::Boolean] => true,
      [Braintrust::Internal::Type::Unknown, Braintrust::Internal::Type::Boolean] => false,
...
class Braintrust::Test::MetaInfoTest < Minitest::Test
  A1 = Braintrust::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Braintrust::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
