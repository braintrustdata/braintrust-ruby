...
class Braintrust::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < Braintrust::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { Braintrust::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { Braintrust::Internal::Util::ParsedUri }
    assert_raises(err) { Braintrust::Internal::Util::ServerSentEvent }
    assert_raises(err) { Braintrust::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { Braintrust::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { Braintrust::Internal::Transport::PooledNetRequester::Request }
