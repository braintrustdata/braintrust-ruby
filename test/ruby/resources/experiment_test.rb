...
class Ruby::Test::Resources::ExperimentTest < Test::Unit::TestCase
  def setup
  ...
  def test_create_required_params
    ...
    assert_kind_of(Ruby::Models::Experiment, response)
  end
  ...
  def test_summarize
    ...
    assert_kind_of(Ruby::Models::ExperimentSummarizeResponse, response)
  end
end
