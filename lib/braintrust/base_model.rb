...
module Braintrust
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Braintrust::Converter | Module | Symbol
          -> { spec }
        in true | false
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Braintrust::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | Braintrust::Converter | Module | Hash
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        ...
        resolved.nil? ? Braintrust::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Braintrust::Union) && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value)
      ...
      known_variants.each do |_, variant_fn|
        ...
        case Braintrust::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
  ...
  class ArrayOf
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { Braintrust::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { Braintrust::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Braintrust::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class HashOf
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Braintrust::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Braintrust::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Braintrust::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | Braintrust::Converter
        ...
        define_method(name_sym) do
          ...
          Braintrust::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise Braintrust::ConversionError.new(
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, Braintrust::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case Braintrust::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= Braintrust::BaseModel
              type.new(value)
