    ...
    module Util
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          val = val.inner if val.is_a?(Braintrust::Internal::Util::SerializationAdapter)
        ...
        def encode_content(headers, body)
          ...
          body = body.inner if body.is_a?(Braintrust::Internal::Util::SerializationAdapter)

          case [content_type, body]
          in [Braintrust::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.fast_generate(body)]
          in [Braintrust::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(StringIO) || body.is_a?(IO)
