    ...
    module Util
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in Braintrust::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [Braintrust::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Braintrust::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(Braintrust::Internal::Type::FileInput)
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Braintrust::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Braintrust::Internal::Util::JSON_CONTENT
          ...
          in Braintrust::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Braintrust::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Braintrust::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            else
              type
            end
