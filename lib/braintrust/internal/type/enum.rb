    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          Braintrust::Internal::Type::Enum === other && other.values.to_set == values.to_set
        ...
        # @return [Object]
        def to_sorbet_type
          types = values.map { Braintrust::Internal::Util::SorbetRuntimeSupport.to_sorbet_type(_1) }.uniq
          case types
          in []
            T.noreturn
          in [type]
