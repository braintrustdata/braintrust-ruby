    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<Braintrust::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, Braintrust::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            meta = Braintrust::Internal::Type::Converter.meta_info(type_info, spec)
            type_fn, info =
              case type_info
              in Proc | Braintrust::Internal::Type::Converter | Class
                [Braintrust::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [Braintrust::Internal::Type::Converter.type_info(type_info), type_info]
              end

            setter = :"#{name_sym}="
            api_name = info.fetch(:api_name, name_sym)
            nilable = info.fetch(:nil?, false)
            const = required && !nilable ? info.fetch(:const, Braintrust::Internal::OMIT) : Braintrust::Internal::OMIT
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = Braintrust::Internal::Type::Converter.new_coerce_state(translate_names: false)
              coerced = Braintrust::Internal::Type::Converter.coerce(target, value, state: state)
              status = @coerced.store(name_sym, state.fetch(:error) || true)
              stored =
                case [target, status]
                in [Braintrust::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if Braintrust::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise Braintrust::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  ...
                  if (nilable || !required) && value.nil?
                    ...
                    Braintrust::Internal::Type::Converter.coerce(
        ...
        class << self
          ...
          def coerce(value, state:)
            ...
            unless (val = Braintrust::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = Braintrust::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in Braintrust::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = Braintrust::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, Braintrust::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            rec = ->(x) do
              ...
              in Braintrust::Internal::Type::BaseModel
                if convert
                  ...
                  rescue Braintrust::Errors::ConversionError
                    [key, rec.call(val)]
                  end
                else
                  rec.call(x.to_h)
        ...
        #
        # @return [String]
        def to_yaml(*a) = Braintrust::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          Braintrust::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                Braintrust::Internal::Type::Converter.inspect(type, depth: depth),
