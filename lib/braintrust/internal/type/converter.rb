    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Braintrust::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Braintrust::Internal::Type::Unknown.dump(_1, state: state) }
        ...
        class << self
          ...
          #
          # @param target [Braintrust::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Braintrust::Internal::Type::Converter.new_coerce_state)
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Braintrust::Internal::Type::Converter, T::Class[T.anything]) }
        end
