...
module Braintrust
  module Internal
    module Type
      ...
      # `Braintrust::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Braintrust::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Braintrust::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in StringIO | String
              ...
              Braintrust::FilePart.new(value, filename: "upload")
            in IO
              state[:can_retry] = false
              value.to_path.nil? ? Braintrust::FilePart.new(value, filename: "upload") : value
            in Braintrust::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
              value
            else
              value
