    ...
    module Transport
      ...
      class BaseClient
        ...
        def initialize(
          ...
          @base_url = Braintrust::Internal::Util.parse_uri(base_url)
        ...
        private def build_request(req, opts)
          ...
          {
            method: method,
            url: Braintrust::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
            decoded = Kernel.then do
              Braintrust::Internal::Util.decode_content(response, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
        ...
        def request(req)
          ...
          decoded = Braintrust::Internal::Util.decode_content(response, stream: stream)
          case req
          in {stream: Class => st}
          ...
          in {page: Class => page}
            ...
            unwrapped = Braintrust::Internal::Util.dig(decoded, req[:unwrap])
        ...
        def inspect
          ...
          base_url = Braintrust::Internal::Util.unparse_uri(@base_url)
