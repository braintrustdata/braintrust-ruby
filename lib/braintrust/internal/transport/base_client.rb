  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Braintrust::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Braintrust::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Braintrust::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise Braintrust::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if Braintrust::Internal::Util.uri_origin(url) != Braintrust::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, Braintrust::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in Braintrust::Errors::APIConnectionError | (500..)
              Braintrust::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        def initialize(
          ...
          @requester = Braintrust::Internal::Transport::PooledNetRequester.new
          @headers = Braintrust::Internal::Util.normalized_headers(
          ...
          @base_url_components = Braintrust::Internal::Util.parse_uri(base_url)
          @base_url = Braintrust::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{Braintrust::VERSION}"
        ...
        #
        #   @option req [Class<Braintrust::Internal::Type::BaseStream>, nil] :stream
        #
        #   @option req [Braintrust::Internal::Type::Converter, Class, nil] :model
        #
        ...
        private def build_request(req, opts)
          ...
          path = Braintrust::Internal::Util.interpolate_path(uninterpolated_path)

          query = Braintrust::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              Braintrust::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          url = Braintrust::Internal::Util.join_parsed_uri(
            @base_url_components,
            {**req, path: path, query: query}
          )
          headers, encoded = Braintrust::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {**request.except(:timeout), deadline: Braintrust::Internal::Util.monotonic_secs + timeout}
          ...
          headers = Braintrust::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise Braintrust::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
          ...
          in Braintrust::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              Braintrust::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise Braintrust::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | Braintrust::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param stream [Class<Braintrust::Internal::Type::BaseStream>, nil]
        #
        # @param model [Braintrust::Internal::Type::Converter, Class, nil]
        #
        # @param options [Braintrust::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { Braintrust::Internal::Type::Unknown }
          ...
          headers = Braintrust::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = Braintrust::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            unwrapped = Braintrust::Internal::Util.dig(decoded, unwrap)
            Braintrust::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
          ...
          T.type_alias do
            {
              ...
              options: T.nilable(Braintrust::RequestOptions::OrHash)
            }
          end
        end
