  ...
  module Models
    class RoleCreateParams < Braintrust::BaseModel
      ...
      class MemberPermission < Braintrust::BaseModel
        ...
        #     into roles
        #
        #   @return [Symbol, Braintrust::Models::RoleCreateParams::MemberPermission::Permission]
        required :permission, enum: -> { Braintrust::Models::RoleCreateParams::MemberPermission::Permission }

        # @!attribute restrict_object_type
        #   The object type that the ACL applies to
        #
        #   @return [Symbol, Braintrust::Models::RoleCreateParams::MemberPermission::RestrictObjectType, nil]
        optional :restrict_object_type,
                 enum: -> { Braintrust::Models::RoleCreateParams::MemberPermission::RestrictObjectType },
                 nil?: true

        # @!parse
        #   # @param permission [Symbol, Braintrust::Models::RoleCreateParams::MemberPermission::Permission]
        #   # @param restrict_object_type [Symbol, Braintrust::Models::RoleCreateParams::MemberPermission::RestrictObjectType, nil]
        #   #
