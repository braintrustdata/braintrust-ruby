...
module Braintrust
  module Models
    class InsertExperimentEvent < Braintrust::BaseModel
      ...
      #   @return [Braintrust::Models::InsertExperimentEvent::Context]
      optional :context, -> { Braintrust::Models::InsertExperimentEvent::Context }
      ...
      #   @return [Braintrust::Models::InsertExperimentEvent::Metrics]
      optional :metrics, -> { Braintrust::Models::InsertExperimentEvent::Metrics }
      ...
      # @!parse
      #   # Create a new instance of InsertExperimentEvent from a Hash of raw data.
      #   #
      #   # @param data [Hash{Symbol => Object}] .
      #   #   @option data [String, nil] :id A unique identifier for the experiment event. If you don't provide one,
      ...
      #   #   @option data [Hash, nil] :_object_delete Pass `_object_delete=true` to mark the experiment event deleted. Deleted events
      ...
      #   #     experiment event
      #   #   @option data [String, nil] :created The timestamp the experiment event was created
