...
module Braintrust
  module Models
    class ExperimentFetchResponse < BaseModel
          ...
          #   @return [Array<Braintrust::Models::ExperimentFetchResponse::Event>]
          required :events, Braintrust::ArrayOf.new(-> { Braintrust::Models::ExperimentFetchResponse::Event })
          ...
          class Event < BaseModel
                ...
                #   @return [Braintrust::Models::ExperimentFetchResponse::Event::Context]
                optional :context, -> { Braintrust::Models::ExperimentFetchResponse::Event::Context }
                ...
                #   @return [Braintrust::Models::ExperimentFetchResponse::Event::Metrics]
                optional :metrics, -> { Braintrust::Models::ExperimentFetchResponse::Event::Metrics }
                ...
                #   @return [Braintrust::Models::ExperimentFetchResponse::Event::SpanAttributes]
                optional :span_attributes, -> { Braintrust::Models::ExperimentFetchResponse::Event::SpanAttributes }
