...
module Braintrust
  module Models
    class InsertExperimentEventMerge < Braintrust::BaseModel
      ...
      class SpanAttributes < Braintrust::BaseModel
        ...
        #   @return [Symbol, Braintrust::Models::InsertExperimentEventMerge::SpanAttributes::Type]
      ...
      # @!parse
      #   # Create a new instance of InsertExperimentEventMerge from a Hash of raw data.
      #   #
      #   # @param data [Hash{Symbol => Object}] .
