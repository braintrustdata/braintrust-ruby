...
module Braintrust
  module Models
    class View < Braintrust::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Braintrust::View::ViewType, nil]
      ...
      #
      #   @param view_type [Symbol, Braintrust::View::ViewType, nil] Type of table that the view corresponds to.
      #
