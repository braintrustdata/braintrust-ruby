...
module Braintrust
  module Models
    class FunctionCreateParams < Braintrust::BaseModel
      ...
      # ```ruby
      # case function_data
      # in Braintrust::Models::FunctionCreateParams::FunctionData::Prompt
      #   # ...
      # in Braintrust::Models::FunctionCreateParams::FunctionData::Code
      #   # ...
      # in Braintrust::Models::FunctionCreateParams::FunctionData::Global
      #   # ...
      # end
      # ```
      class FunctionData < Braintrust::Union
        ...
        class Code < Braintrust::BaseModel
          ...
          # ```ruby
          # case data
          # in Braintrust::Models::FunctionCreateParams::FunctionData::Code::Data::Bundle
          #   # ...
          # in Braintrust::Models::FunctionCreateParams::FunctionData::Code::Data::Inline
          #   # ...
          # end
          # ```
      ...
      class Origin < Braintrust::BaseModel
        ...
        #
        #   @return [Symbol, Braintrust::Models::FunctionCreateParams::Origin::ObjectType]
        required :object_type, enum: -> { Braintrust::Models::FunctionCreateParams::Origin::ObjectType }
        ...
        #   # @param object_type [Symbol, Braintrust::Models::FunctionCreateParams::Origin::ObjectType]
