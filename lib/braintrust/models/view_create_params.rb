...
module Braintrust
  module Models
    class ViewCreateParams < Braintrust::BaseModel
      ...
      #
      #   @return [Symbol, Braintrust::Models::ViewCreateParams::ObjectType]
      required :object_type, enum: -> { Braintrust::Models::ViewCreateParams::ObjectType }
      ...
      #   # @param object_type [Symbol, Braintrust::Models::ViewCreateParams::ObjectType]
