...
module Braintrust
  module Models
    class InsertProjectLogsEventReplace < Braintrust::BaseModel
      # @!attribute [rw] id
      ...
      class SpanAttributes < Braintrust::BaseModel
        ...
        #   @return [Symbol, Braintrust::Models::InsertProjectLogsEventReplace::SpanAttributes::Type]
      ...
      # @!parse
      #   # Create a new instance of InsertProjectLogsEventReplace from a Hash of raw data.
      #   #
      #   # @param data [Hash{Symbol => Object}] .
      ...
      #   #     logs event
      #   #   @option data [String, nil] :created The timestamp the project logs event was created
