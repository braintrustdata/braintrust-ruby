...
module Braintrust
  module Models
    class LogFetchResponse < BaseModel
          ...
          #   @return [Array<Braintrust::Models::LogFetchResponse::Event>]
          required :events, Braintrust::ArrayOf.new(-> { Braintrust::Models::LogFetchResponse::Event })
          ...
          class Event < BaseModel
                ...
                #   @return [Braintrust::Models::LogFetchResponse::Event::Context]
                optional :context, -> { Braintrust::Models::LogFetchResponse::Event::Context }
                ...
                #   @return [Braintrust::Models::LogFetchResponse::Event::Metrics]
                optional :metrics, -> { Braintrust::Models::LogFetchResponse::Event::Metrics }
                ...
                #   @return [Braintrust::Models::LogFetchResponse::Event::SpanAttributes]
                optional :span_attributes, -> { Braintrust::Models::LogFetchResponse::Event::SpanAttributes }
