...
module Braintrust
  module Models
    ...
    class RoleReplaceParams < Braintrust::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Braintrust::RoleReplaceParams::MemberPermission>, nil]
      optional :member_permissions,
               -> { Braintrust::Internal::Type::ArrayOf[Braintrust::RoleReplaceParams::MemberPermission] },
               nil?: true
      ...
      class MemberPermission < Braintrust::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Braintrust::RoleReplaceParams::MemberPermission} for more details.
        #
