  ...
  module Models
    ...
    class RoleReplaceParams < Braintrust::Internal::Type::BaseModel
      ...
      optional :member_permissions,
               -> { Braintrust::Internal::Type::ArrayOf[Braintrust::Models::RoleReplaceParams::MemberPermission] },
               nil?: true
      ...
      class MemberPermission < Braintrust::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Braintrust::Models::RoleReplaceParams::MemberPermission} for more details.
        #
