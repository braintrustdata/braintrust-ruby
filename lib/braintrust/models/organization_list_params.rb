...
module Braintrust
  module Models
    class OrganizationListParams < Braintrust::BaseModel
      ...
      #   #
      #   def initialize(ending_before: nil, ids: nil, limit: nil, org_name: nil, starting_after: nil, request_options: {}, **) = super
      ...
      # in String
      #   # ...
      # in Braintrust::Models::OrganizationListParams::IDs::StringArray
      #   # ...
      # end
      # ```
