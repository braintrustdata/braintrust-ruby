...
module Braintrust
  module Models
    class FunctionListParams < Braintrust::BaseModel
      ...
      optional :ids, union: -> { Braintrust::Models::FunctionListParams::IDs }
      ...
      # in String
      #   # ...
      # in Braintrust::Models::FunctionListParams::IDs::StringArray
      #   # ...
      # end
      # ```
      class IDs < Braintrust::Union
        ...
        variant Braintrust::Models::FunctionListParams::IDs::StringArray
      end
    end
  end
end
