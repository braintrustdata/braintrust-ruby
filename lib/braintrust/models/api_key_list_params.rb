...
module Braintrust
  module Models
    ...
    class APIKeyListParams < Braintrust::Internal::Type::BaseModel
      ...
      # @!method initialize(api_key_name: nil, ending_before: nil, ids: nil, limit: nil, org_name: nil, starting_after: nil, request_options: {})
