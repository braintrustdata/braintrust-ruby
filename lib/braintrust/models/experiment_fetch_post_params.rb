...
module Braintrust
  module Models
    # @see Braintrust::Resources::Experiments#fetch_post
    class ExperimentFetchPostParams < Braintrust::Internal::Type::BaseModel
      # @!parse
      ...
      #   #
      #   def initialize(cursor: nil, limit: nil, max_root_span_id: nil, max_xact_id: nil, version: nil, request_options: {}, **) = super
