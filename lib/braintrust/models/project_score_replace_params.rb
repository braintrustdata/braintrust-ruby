...
module Braintrust
  module Models
    class ProjectScoreReplaceParams < Braintrust::BaseModel
      ...
      # ```ruby
      # case categories
      # in Braintrust::Models::ProjectScoreReplaceParams::Categories::ProjectScoreCategoryArray
      #   # ...
      # in Braintrust::Models::ProjectScoreReplaceParams::Categories::FloatMap
      #   # ...
      # in Braintrust::Models::ProjectScoreReplaceParams::Categories::StringArray
      #   # ...
      # in Braintrust::Models::ProjectScoreReplaceParams::Categories::NullableVariant
      #   # ...
      # end
      # ```
