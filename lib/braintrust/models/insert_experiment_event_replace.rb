...
module Braintrust
  module Models
    class InsertExperimentEventReplace < Braintrust::BaseModel
      # @!attribute [rw] id
      ...
      class SpanAttributes < Braintrust::BaseModel
        ...
        #   @return [Symbol, Braintrust::Models::InsertExperimentEventReplace::SpanAttributes::Type]
        optional :type, enum: -> { Braintrust::Models::InsertExperimentEventReplace::SpanAttributes::Type }
      ...
      # @!parse
      #   # Create a new instance of InsertExperimentEventReplace from a Hash of raw data.
      #   #
      #   # @param data [Hash{Symbol => Object}] .
