...
module Braintrust
  module Transport
    ...
    class BaseClient
      ...
      class << self
        ...
        def reap_connection!(status, stream:)
          ...
          in Braintrust::Errors::APIConnectionError | (500..)
            Braintrust::Util.close_fused!(stream)
          else
          end
        end
      end
      ...
      # @api private
      # @return [Braintrust::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Braintrust::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Braintrust::Type::Converter, Class, nil] :model
      #
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            Braintrust::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        decoded = Braintrust::Util.decode_content(response, stream: stream)
        case req
        in { stream: Class => st }
        ...
        in { page: Class => page }
          ...
          Braintrust::Type::Converter.coerce(model, unwrapped)
        end
      end
