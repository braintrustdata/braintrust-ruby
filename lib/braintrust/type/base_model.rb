...
module Braintrust
  module Type
    ...
    #   }
    class BaseModel
      extend Braintrust::Type::Converter
      ...
      class << self
        ...
        #
        # @param type_info [Hash{Symbol=>Object}, Proc, Braintrust::Type::Converter, Class]
        #
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | Braintrust::Type::Converter | Class
              [Braintrust::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [Braintrust::Type::Converter.type_info(type_info), type_info]
            end
          ...
          define_method(name_sym) do
            ...
            if (nilable || !required) && value.nil?
              ...
              Braintrust::Type::Converter.coerce(
                target,
                value,
                state: state
              )
        ...
        def coerce(value, state:)
          ...
          fields.each do |name, field|
            ...
            unless val.key?(api_name)
              if required && mode != :dump && const == Braintrust::Util::OMIT
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = Braintrust::Type::Converter.coerce(target, item, state: state)
                case target
                in Braintrust::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, Braintrust::Type::Converter.dump(target, val))
              end
            end
          end
