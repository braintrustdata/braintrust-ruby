    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in Braintrust::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Braintrust::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Braintrust::Type::Converter) ? target.dump(value) : Braintrust::Unknown.dump(value)
        end
      end
    end
