...
module Braintrust
  module Resources
    class Function
      ...
      # @option params [FunctionData::UnnamedTypeWithunionParent17|FunctionData::UnnamedTypeWithunionParent18|FunctionData::UnnamedTypeWithunionParent19] :function_data
      ...
      # @param params [Hash] Attributes to send in this request.
      # @option params [String] :description Textual description of the prompt
      # @option params [FunctionData::UnnamedTypeWithunionParent20|FunctionData::UnnamedTypeWithunionParent21|FunctionData::UnnamedTypeWithunionParent22|FunctionData::UnnamedTypeWithunionParent23] :function_data
      # @option params [String] :name Name of the prompt
      # @option params [Braintrust::Models::PromptData] :prompt_data The prompt, model, and its parameters
      # @option params [Array<String>] :tags A list of tags for the prompt
      # 
