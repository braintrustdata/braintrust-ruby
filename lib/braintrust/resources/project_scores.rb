...
module Braintrust
  module Resources
    class ProjectScores
      ...
      #   @option params [Array<Braintrust::Models::ProjectScoreCategory>, Array<String>, Braintrust::Models::ProjectScoreCreateParams::Categories::UnnamedTypeWithunionParent18, Hash, nil] :categories For categorical-type project scores, the list of all categories
      ...
      #
      # @param params [Hash{Symbol => Object}] Attributes to send in this request.
      #   @option params [Array<Braintrust::Models::ProjectScoreCategory>, Array<String>, Braintrust::Models::ProjectScoreUpdateParams::Categories::UnnamedTypeWithunionParent19, Hash, nil] :categories For categorical-type project scores, the list of all categories
      #   @option params [Braintrust::Models::ProjectScoreConfig, nil] :config
      #   @option params [String, nil] :description Textual description of the project score
      ...
      #   @option params [Array<Symbol, Braintrust::Models::ProjectScoreListParams::ScoreType::UnnamedTypeWithunionParent21>, Symbol, Braintrust::Models::ProjectScoreListParams::ScoreType::UnnamedTypeWithunionParent20, nil] :score_type The type of the configured score
      ...
      #   @option params [Array<Braintrust::Models::ProjectScoreCategory>, Array<String>, Braintrust::Models::ProjectScoreReplaceParams::Categories::UnnamedTypeWithunionParent22, Hash, nil] :categories For categorical-type project scores, the list of all categories
      #   @option params [Braintrust::Models::ProjectScoreConfig, nil] :config
      #   @option params [String, nil] :description Textual description of the project score
      #
      # @param opts [Hash{Symbol => Object}, Braintrust::RequestOptions] Options to specify HTTP behaviour for this request.
