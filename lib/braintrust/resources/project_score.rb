...
module Braintrust
  module Resources
    class ProjectScore
      ...
      # @option params [Array<Braintrust::Models::ProjectScoreCategory>|Array<String>|Categories::UnnamedTypeWithunionParent14|Hash] :categories For categorical-type project scores, the list of all categories
      ...
      # 
      # @param params [Hash] Attributes to send in this request.
      # @option params [Array<Braintrust::Models::ProjectScoreCategory>|Array<String>|Categories::UnnamedTypeWithunionParent15|Hash] :categories For categorical-type project scores, the list of all categories
      # @option params [String] :description Textual description of the project score
      # @option params [String] :name Name of the project score
      # @option params [Symbol] :score_type The type of the configured score
      # 
      ...
      # @option params [String] :project_id Unique identifier for the project that the project score belongs under
      # @option params [Symbol] :score_type The type of the configured score
      # @option params [Array<Braintrust::Models::ProjectScoreCategory>|Array<String>|Categories::UnnamedTypeWithunionParent16|Hash] :categories For categorical-type project scores, the list of all categories
      # @option params [String] :description Textual description of the project score
      # 
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
