...
module Braintrust
  [Braintrust::Internal::Type::BaseModel, *Braintrust::Internal::Type::BaseModel.subclasses].each do |cls|
    cls.define_sorbet_constant!(:OrHash) { T.type_alias { T.any(cls, Braintrust::Internal::AnyHash) } }
  end

  Braintrust::Internal::Util.walk_namespaces(Braintrust::Models).each do |mod|
    case mod
    in Braintrust::Internal::Type::Enum | Braintrust::Internal::Type::Union
  ...
  Braintrust::Internal::Util.walk_namespaces(Braintrust::Models)
                            .lazy
                            .grep(Braintrust::Internal::Type::Union)
                            .each do |mod|
    const = :Variants
