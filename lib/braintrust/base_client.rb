...
module Braintrust
  ...
  class BaseClient
    ...
    def initialize(
      ...
      @base_path = Braintrust::Util.normalize_path(base_url_parsed.path)
    ...
    # @param opts [Hash{Symbol => Object}, Braintrust::RequestOptions]
    #
    # @raise [ArgumentError]
    def validate_request(req, opts)
      ...
      in Braintrust::RequestOptions | Hash
        valid_keys = Braintrust::RequestOptions.options
      ...
      loop do # rubocop:disable Metrics/BlockLength
        ...
        begin
          ...
          if status < 300
            ...
            prev_uri = Braintrust::Util.unparse_uri(request)
            ...
            # from undici
            if Braintrust::Util.uri_origin(prev_uri) != Braintrust::Util.uri_origin(location)
              request[:headers] = request[:headers].reject do |k|
