...
module Braintrust
  ...
  class BaseClient
    ...
    def validate_request(req, opts)
      ...
      unless opts.is_a?(Hash) || opts.is_a?(Braintrust::RequestOption)
      ...
      opts.to_h.each_key do |k|
        ...
        unless (valid_keys = Braintrust::RequestOptions.options).include?(k)
      ...
      loop do # rubocop:disable Metrics/BlockLength
        begin
          ...
          if status < 300
            ...
            begin
              prev_uri = URI.parse(Braintrust::Util.uri_from_req(request, absolute: true))
