  ...
  module Resources
    class Project
      class Logs
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [Ruby::Models::LogFetchResponse]
        def fetch(project_id, params = {}, opts = {})
          req = {}
          req[:method] = :get
          req[:path] = "/v1/project_logs/#{project_id}/fetch"
          req[:query] = params
          req[:model] = Ruby::Models::LogFetchResponse
          @client.request(req, opts)
        end
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [Ruby::Models::LogFetchPostResponse]
        def fetch_post(project_id, params = {}, opts = {})
          req = {}
          req[:method] = :post
          req[:path] = "/v1/project_logs/#{project_id}/fetch"
          req[:body] = params
          req[:model] = Ruby::Models::LogFetchPostResponse
          @client.request(req, opts)
        end
        ...
        # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
        # 
        # @return [Ruby::Models::LogInsertResponse]
        def insert(project_id, params = {}, opts = {})
          req = {}
          req[:method] = :post
          req[:path] = "/v1/project_logs/#{project_id}/insert"
          req[:body] = params
          req[:model] = Ruby::Models::LogInsertResponse
          @client.request(req, opts)
        end
      end
    end
