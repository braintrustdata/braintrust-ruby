...
module Ruby
  module Resources
    class Project
      # @return [Ruby::Resources::Project::Logs]
      attr_reader :logs

      def initialize(client:)
        @client = client
        @logs = Ruby::Resources::Project::Logs.new(client: client)
      end
      ...
      # 
      # @return [Ruby::Models::Project]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/project"
        req[:body] = params
        req[:model] = Ruby::Models::Project
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::ListObjects<Ruby::Models::Project>]
