...
module Ruby
  module Resources
    class Experiment
      ...
      # 
      # @return [Ruby::Models::Experiment]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/experiment"
        req[:body] = params
        req[:model] = Ruby::Models::Experiment
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::ListObjects<Ruby::Models::Experiment>]
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::ExperimentFetchResponse]
      def fetch(experiment_id, params = {}, opts = {})
        req = {}
        req[:method] = :get
        req[:path] = "/v1/experiment/#{experiment_id}/fetch"
        req[:query] = params
        req[:model] = Ruby::Models::ExperimentFetchResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::ExperimentFetchPostResponse]
      def fetch_post(experiment_id, params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/experiment/#{experiment_id}/fetch"
        req[:body] = params
        req[:model] = Ruby::Models::ExperimentFetchPostResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::ExperimentInsertResponse]
      def insert(experiment_id, params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/experiment/#{experiment_id}/insert"
        req[:body] = params
        req[:model] = Ruby::Models::ExperimentInsertResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::ExperimentSummarizeResponse]
      def summarize(experiment_id, params = {}, opts = {})
        req = {}
        req[:method] = :get
        req[:path] = "/v1/experiment/#{experiment_id}/summarize"
        req[:query] = params
        req[:model] = Ruby::Models::ExperimentSummarizeResponse
        @client.request(req, opts)
      end
    end
  end
