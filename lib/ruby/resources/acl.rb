...
module Ruby
  module Resources
    class ACL
      ...
      #   provided
      # @option params [Symbol] :restrict_object_type Optionally restricts the permission grant to just the specified object type
      ...
      # 
      # @return [Ruby::Models::ACL]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/acl"
        req[:body] = params
        req[:model] = Ruby::Models::ACL
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::ListObjects<Ruby::Models::ACL>]
