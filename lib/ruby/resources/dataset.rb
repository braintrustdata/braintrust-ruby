...
module Ruby
  module Resources
    class Dataset
      ...
      # 
      # @return [Ruby::Models::Dataset]
      def create(params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/dataset"
        req[:body] = params
        req[:model] = Ruby::Models::Dataset
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::ListObjects<Ruby::Models::Dataset>]
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::DatasetFetchResponse]
      def fetch(dataset_id, params = {}, opts = {})
        req = {}
        req[:method] = :get
        req[:path] = "/v1/dataset/#{dataset_id}/fetch"
        req[:query] = params
        req[:model] = Ruby::Models::DatasetFetchResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::DatasetFetchPostResponse]
      def fetch_post(dataset_id, params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/dataset/#{dataset_id}/fetch"
        req[:body] = params
        req[:model] = Ruby::Models::DatasetFetchPostResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::DatasetInsertResponse]
      def insert(dataset_id, params = {}, opts = {})
        req = {}
        req[:method] = :post
        req[:path] = "/v1/dataset/#{dataset_id}/insert"
        req[:body] = params
        req[:model] = Ruby::Models::DatasetInsertResponse
        @client.request(req, opts)
      end
      ...
      # @param opts [Hash|RequestOptions] Options to specify HTTP behaviour for this request.
      # 
      # @return [Ruby::Models::DatasetSummarizeResponse]
      def summarize(dataset_id, params = {}, opts = {})
        req = {}
        req[:method] = :get
        req[:path] = "/v1/dataset/#{dataset_id}/summarize"
        req[:query] = params
        req[:model] = Ruby::Models::DatasetSummarizeResponse
        @client.request(req, opts)
      end
    end
  end
