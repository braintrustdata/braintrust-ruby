...
module Ruby
  module Models
    class ExperimentFetchResponse < BaseModel
      ...
      #   @return [Array<Ruby::Models::ExperimentFetchResponse::Event>]
      required :events, Ruby::ArrayOf.new(-> { Ruby::Models::ExperimentFetchResponse::Event })
      ...
      class Event < BaseModel
        ...
        #   @return [Ruby::Models::ExperimentFetchResponse::Event::Context]
        optional :context, -> { Ruby::Models::ExperimentFetchResponse::Event::Context }
        ...
        #   @return [Ruby::Models::ExperimentFetchResponse::Event::Metrics]
        optional :metrics, -> { Ruby::Models::ExperimentFetchResponse::Event::Metrics }
        ...
        #   @return [Ruby::Models::ExperimentFetchResponse::Event::SpanAttributes]
        optional :span_attributes, -> { Ruby::Models::ExperimentFetchResponse::Event::SpanAttributes }
