...
module Ruby
  module Models
    class ExperimentFetchPostResponse < BaseModel
      ...
      #   @return [Array<Ruby::Models::ExperimentFetchPostResponse::Event>]
      required :events, Ruby::ArrayOf.new(-> { Ruby::Models::ExperimentFetchPostResponse::Event })
      ...
      class Event < BaseModel
        ...
        #   A unique identifier used to link different experiment events together as part of a full trace. See the [tracing guide](https://www.braintrustdata.com/docs/guides/tracing) for full details on tracing
        #   @return [String]
        ...
        #   @return [Ruby::Models::ExperimentFetchPostResponse::Event::Context]
        optional :context, -> { Ruby::Models::ExperimentFetchPostResponse::Event::Context }
        ...
        #   @return [Ruby::Models::ExperimentFetchPostResponse::Event::Metrics]
        optional :metrics, -> { Ruby::Models::ExperimentFetchPostResponse::Event::Metrics }

        # @!attribute [rw] output
        #   The output of your application, including post-processing (an arbitrary, JSON serializable object), that allows you to determine whether the result is correct or not. For example, in an app that generates SQL queries, the `output` should be the _result_ of the SQL query generated by the model, not the query itself, because there may be multiple valid queries that answer a single question
        #   @return [Object]
        optional :output, Ruby::Unknown
        ...
        #   @return [Ruby::Models::ExperimentFetchPostResponse::Event::SpanAttributes]
        optional :span_attributes, -> { Ruby::Models::ExperimentFetchPostResponse::Event::SpanAttributes }
        ...
        #   @return [Array<String>]
        optional :span_parents, Ruby::ArrayOf.new(String)
        ...
        class SpanAttributes < BaseModel
          ...
          #   @return [Symbol]
          optional :type, Ruby::Enum.new(:llm, :score, :function, :eval, :task, :tool)
        end
      end
    end
  end
