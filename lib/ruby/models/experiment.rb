...
module Ruby
  module Models
    class Experiment < BaseModel
      ...
      #   @return [Boolean]
      required :public, Ruby::BooleanModel
      ...
      #   @return [Ruby::Models::Experiment::RepoInfo]
      optional :repo_info, -> { Ruby::Models::Experiment::RepoInfo }
      ...
      class RepoInfo < BaseModel
        ...
        #   @return [Boolean]
        optional :dirty, Ruby::BooleanModel
