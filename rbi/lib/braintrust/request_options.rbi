...
module Braintrust
  module RequestParameters
    ...
    sig { returns(T.any(Braintrust::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Braintrust::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Braintrust::RequestOptions, T::Hash[Symbol, T.anything]))
    end
