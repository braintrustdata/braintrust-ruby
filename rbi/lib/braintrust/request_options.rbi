...
module Braintrust
  ...
  module RequestParameters
    ...
    sig do
      params(_: T.any(Braintrust::RequestOptions, Braintrust::Util::AnyHash))
        .returns(T.any(Braintrust::RequestOptions, Braintrust::Util::AnyHash))
    end
  ...
  class RequestOptions < Braintrust::BaseModel
    ...
    sig { params(values: Braintrust::Util::AnyHash).returns(T.attached_class) }
    def self.new(values = {})
    end
  end
end
