      ...
      class Categories < Braintrust::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[NilClass, T::Array[Braintrust::Models::ProjectScoreCategory]], [NilClass, T::Hash[Symbol, Float]], [NilClass, T::Array[String]], [NilClass, Braintrust::Models::ProjectScoreReplaceParams::Categories::NullableVariant]]
              )
          end
