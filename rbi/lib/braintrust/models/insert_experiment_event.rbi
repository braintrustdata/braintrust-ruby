    ...
    class InsertExperimentEvent < Braintrust::BaseModel
      ...
      sig do
        params(
          ...
          context: T.nilable(T.any(Braintrust::Models::InsertExperimentEvent::Context, Braintrust::Util::AnyHash)),
          created: T.nilable(Time),
          error: T.anything,
          expected: T.anything,
          input: T.anything,
          metadata: T.nilable(T.any(Braintrust::Models::InsertExperimentEvent::Metadata, Braintrust::Util::AnyHash)),
          metrics: T.nilable(T.any(Braintrust::Models::InsertExperimentEvent::Metrics, Braintrust::Util::AnyHash)),
