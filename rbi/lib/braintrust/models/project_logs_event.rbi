...
module Braintrust
  module Models
    class ProjectLogsEvent < Braintrust::BaseModel
      ...
      sig do
        params(_: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Context, Braintrust::Util::AnyHash)))
          .returns(T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Context, Braintrust::Util::AnyHash)))
      end
      def context=(_)
      end
      ...
      sig do
        params(_: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metadata, Braintrust::Util::AnyHash)))
          .returns(T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metadata, Braintrust::Util::AnyHash)))
      end
      def metadata=(_)
      end
      ...
      sig do
        params(_: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metrics, Braintrust::Util::AnyHash)))
          .returns(T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metrics, Braintrust::Util::AnyHash)))
      end
      def metrics=(_)
      end
      ...
      sig do
        params(
          ...
          root_span_id: String,
          span_id: String,
          context: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Context, Braintrust::Util::AnyHash)),
          error: T.anything,
          expected: T.anything,
          input: T.anything,
          is_root: T.nilable(T::Boolean),
          metadata: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metadata, Braintrust::Util::AnyHash)),
          metrics: T.nilable(T.any(Braintrust::Models::ProjectLogsEvent::Metrics, Braintrust::Util::AnyHash)),
