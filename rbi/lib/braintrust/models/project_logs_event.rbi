...
module Braintrust
  module Models
    class ProjectLogsEvent < Braintrust::BaseModel
      ...
      sig do
        params(_: T.nilable(Braintrust::Models::ProjectLogsEvent::Context))
          .returns(T.nilable(Braintrust::Models::ProjectLogsEvent::Context))
      end
      def context=(_)
      end
      ...
      sig do
        params(_: T.nilable(Braintrust::Models::ProjectLogsEvent::Metrics))
          .returns(T.nilable(Braintrust::Models::ProjectLogsEvent::Metrics))
      end
      def metrics=(_)
      end

      sig { returns(T.nilable(Braintrust::Models::ProjectLogsEvent::Origin)) }
      def origin
      end

      sig do
        params(_: T.nilable(Braintrust::Models::ProjectLogsEvent::Origin))
          .returns(T.nilable(Braintrust::Models::ProjectLogsEvent::Origin))
      end
      def origin=(_)
      end
      ...
      sig do
        params(
          ...
          origin: T.nilable(Braintrust::Models::ProjectLogsEvent::Origin),
          output: T.anything,
