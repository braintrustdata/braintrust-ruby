...
module Braintrust
  module Internal
    ...
    module Util
      ...
      #   structure when using `Braintrust::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Braintrust::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(Braintrust::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: Braintrust::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        ...
        sig do
          params(
            lhs: Braintrust::Internal::Util::ParsedUriShape,
            rhs: Braintrust::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Braintrust::Internal::Util::ServerSentEvent) }
