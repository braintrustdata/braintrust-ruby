  ...
  module Internal
    module Type
      ...
      module Union
        ...
        sig do
          params(
            key: T.any(Symbol, Braintrust::Internal::Util::AnyHash, T.proc.returns(T.anything), T.anything),
            spec: T.any(Braintrust::Internal::Util::AnyHash, T.proc.returns(T.anything), T.anything)
          )
            .void
        end
