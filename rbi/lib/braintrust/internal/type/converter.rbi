...
module Braintrust
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(Braintrust::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: Braintrust::Internal::Type::Converter::CoerceState)
            .returns(T.anything)
        end
        ...
        sig do
          overridable
            .params(value: T.anything, state: Braintrust::Internal::Type::Converter::DumpState)
            .returns(T.anything)
        end
        ...
        class << self
          ...
          sig do
            params(
              target: Braintrust::Internal::Type::Converter::Input,
              value: T.anything,
