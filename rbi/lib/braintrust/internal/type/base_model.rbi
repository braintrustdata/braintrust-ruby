  ...
  module Internal
    module Type
      class BaseModel
          ...
          sig do
            returns(
              ...
              T.all(
                ...
                {type_fn: T.proc.returns(Braintrust::Internal::Type::Converter::Input)}
              )
              ]
            )
          end
              ...
              type_info: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(Braintrust::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(Braintrust::Internal::Type::Converter::Input)),
                  api_name: Symbol,
                  nil?: T::Boolean
                },
        ...
        sig { overridable.returns(Braintrust::Internal::Util::AnyHash) }
        def to_h
        end
        ...
        sig { params(keys: T.nilable(T::Array[Symbol])).returns(Braintrust::Internal::Util::AnyHash) }
