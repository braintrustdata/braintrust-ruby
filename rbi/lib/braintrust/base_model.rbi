...
module Braintrust
  ...
  class Union
    ...
    sig { params(value: T.anything).returns(T.nilable(Braintrust::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(Braintrust::Converter::Input) }
  ...
  class BaseModel
    ...
    sig do
      returns(
        T::Hash[Symbol, T.all(Braintrust::BaseModel::KnownFieldShape, {type: Braintrust::Converter::Input})]
      )
    end
    def self.fields
    end
