...
module Braintrust
  class BaseClient
    ...
    RequestComponentsShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[Braintrust::BaseModel]),
    ...
    sig { params(req: Braintrust::BaseClient::RequestComponentsShape).void }
    ...
    sig do
      params(
        request: Braintrust::BaseClient::RequestInputShape,
        status: Integer,
