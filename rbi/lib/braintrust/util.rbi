...
module Braintrust
  ...
  module Util
    ...
    #   structure when using `Braintrust::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(Braintrust::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(Braintrust::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: Braintrust::Util::ParsedUriShape).returns(URI::Generic) }
      ...
      sig do
        params(
          lhs: Braintrust::Util::ParsedUriShape,
          rhs: Braintrust::Util::ParsedUriShape
        ).returns(URI::Generic)
      end
