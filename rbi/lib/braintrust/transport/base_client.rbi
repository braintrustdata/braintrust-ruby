...
module Braintrust
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Braintrust::Type::BasePage[Braintrust::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(Braintrust::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Braintrust::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Braintrust::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Braintrust::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Braintrust::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Braintrust::Transport::BaseClient::RequestComponentsShape, opts: Braintrust::Util::AnyHash)
          .returns(Braintrust::Transport::BaseClient::RequestInputShape)
      end
