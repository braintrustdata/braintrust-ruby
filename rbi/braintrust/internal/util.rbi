  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Braintrust::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick: T.nilable(
              T.any(
                Symbol,
                Integer,
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(T::Enumerable[Braintrust::Internal::Util::ServerSentEvent])
        end
