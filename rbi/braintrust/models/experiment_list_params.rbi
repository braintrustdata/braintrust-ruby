...
module Braintrust
  module Models
    class ExperimentListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::ExperimentListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Braintrust::ExperimentListParams::IDs::Variants))
      end
      attr_reader :ids

      sig { params(ids: Braintrust::ExperimentListParams::IDs::Variants).void }
      attr_writer :ids
      ...
      sig do
        params(
          ...
          ids: Braintrust::ExperimentListParams::IDs::Variants,
      ...
      module IDs
        ...
        sig do
          override.returns(
            T::Array[Braintrust::ExperimentListParams::IDs::Variants]
          )
        end
        def self.variants
        end
