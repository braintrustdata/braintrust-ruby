  ...
  module Models
    class InsertExperimentEvent < Braintrust::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Braintrust::InsertExperimentEvent,
      ...
      # experiment event
      sig { returns(T.nilable(Braintrust::InsertExperimentEvent::Context)) }
      attr_reader :context

      sig do
        params(
          context: T.nilable(Braintrust::InsertExperimentEvent::Context::OrHash)
        ).void
      end
      attr_writer :context
      ...
      sig { returns(T.nilable(Braintrust::InsertExperimentEvent::Metadata)) }
      attr_reader :metadata

      sig do
        params(
          metadata:
            T.nilable(Braintrust::InsertExperimentEvent::Metadata::OrHash)
        ).void
      end
      ...
      sig { returns(T.nilable(Braintrust::InsertExperimentEvent::Metrics)) }
      attr_reader :metrics

      sig do
        params(
          metrics: T.nilable(Braintrust::InsertExperimentEvent::Metrics::OrHash)
        ).void
      end
      attr_writer :metrics
      ...
      sig do
        params(
          ...
          context:
            T.nilable(Braintrust::InsertExperimentEvent::Context::OrHash),
          ...
          metadata:
            T.nilable(Braintrust::InsertExperimentEvent::Metadata::OrHash),
          metrics:
            T.nilable(Braintrust::InsertExperimentEvent::Metrics::OrHash),
        ...
        override.returns(
          {
            ...
            _object_delete: T.nilable(T::Boolean),
            _parent_id: T.nilable(String),
            context: T.nilable(Braintrust::InsertExperimentEvent::Context),
            created: T.nilable(Time),
            error: T.anything,
            expected: T.anything,
            input: T.anything,
            metadata: T.nilable(Braintrust::InsertExperimentEvent::Metadata),
            metrics: T.nilable(Braintrust::InsertExperimentEvent::Metrics),
      ...
      class Context < Braintrust::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Braintrust::InsertExperimentEvent::Context,
              Braintrust::Internal::AnyHash
            )
          end
      ...
      class Metadata < Braintrust::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Braintrust::InsertExperimentEvent::Metadata,
              Braintrust::Internal::AnyHash
            )
          end
      ...
      class Metrics < Braintrust::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Braintrust::InsertExperimentEvent::Metrics,
              Braintrust::Internal::AnyHash
            )
          end
