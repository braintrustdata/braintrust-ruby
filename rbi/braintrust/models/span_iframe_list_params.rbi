...
module Braintrust
  module Models
    class SpanIframeListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::SpanIframeListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(String)) }
      attr_reader :span_iframe_name

      sig { params(span_iframe_name: String).void }
      attr_writer :span_iframe_name
      ...
      module IDs
        ...
        sig do
          override.returns(
            T::Array[Braintrust::SpanIframeListParams::IDs::Variants]
          )
        end
        def self.variants
        end
