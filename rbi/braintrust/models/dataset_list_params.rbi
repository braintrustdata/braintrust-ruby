...
module Braintrust
  module Models
    class DatasetListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::DatasetListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Braintrust::DatasetListParams::IDs::Variants)) }
      attr_reader :ids

      sig { params(ids: Braintrust::DatasetListParams::IDs::Variants).void }
      attr_writer :ids
