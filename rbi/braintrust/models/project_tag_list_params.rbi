...
module Braintrust
  module Models
    class ProjectTagListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::ProjectTagListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Braintrust::ProjectTagListParams::IDs::Variants))
      end
      attr_reader :ids

      sig { params(ids: Braintrust::ProjectTagListParams::IDs::Variants).void }
      attr_writer :ids
      ...
      module IDs
        ...
        sig do
          override.returns(
            T::Array[Braintrust::ProjectTagListParams::IDs::Variants]
          )
        end
        def self.variants
        end
