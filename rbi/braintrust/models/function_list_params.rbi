...
module Braintrust
  module Models
    class FunctionListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::FunctionListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Braintrust::FunctionListParams::IDs::Variants)) }
      attr_reader :ids

      sig { params(ids: Braintrust::FunctionListParams::IDs::Variants).void }
      attr_writer :ids
