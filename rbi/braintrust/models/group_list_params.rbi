...
module Braintrust
  module Models
    class GroupListParams < Braintrust::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Braintrust::GroupListParams, Braintrust::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Braintrust::GroupListParams::IDs::Variants)) }
      attr_reader :ids

      sig { params(ids: Braintrust::GroupListParams::IDs::Variants).void }
      attr_writer :ids
      ...
      module IDs
        ...
        sig do
          override.returns(T::Array[Braintrust::GroupListParams::IDs::Variants])
        end
        def self.variants
        end
