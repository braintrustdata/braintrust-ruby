  ...
  module Models
    class FetchDatasetEventsResponse < Braintrust::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Braintrust::FetchDatasetEventsResponse,
            Braintrust::Internal::AnyHash
          )
        end

      # A list of fetched events
      sig { returns(T::Array[Braintrust::DatasetEvent]) }
      ...
      sig do
        params(
          events: T::Array[Braintrust::DatasetEvent::OrHash],
      ...
      sig do
        override.returns(
          {
            events: T::Array[Braintrust::DatasetEvent],
            cursor: T.nilable(String)
          }
        )
      end
