...
module Braintrust
  module Models
    class RoleCreateParams < Braintrust::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Braintrust::RoleCreateParams::MemberPermission])
        )
      end
      ...
      sig do
        params(
          ...
          member_permissions:
            T.nilable(
              T::Array[Braintrust::RoleCreateParams::MemberPermission::OrHash]
            ),
        ...
        override.returns(
          {
            ...
            member_permissions:
              T.nilable(
                T::Array[Braintrust::RoleCreateParams::MemberPermission]
              ),
            member_roles: T.nilable(T::Array[String]),
            org_name: T.nilable(String),
